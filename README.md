...
TRANSFORM={"email":"$.traits.email","leadsource":"trial signup", "LastName":"N/A", "FirstName":"$.traits.mk_first_name", "Company":"mk_company_name", "mk_job_role__c":"$.traits.mk_job_role", "mk_seniority__c":"$.traits.mk_seniority"}
